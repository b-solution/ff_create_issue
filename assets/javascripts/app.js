...
function beforeShowDatePicker(input, inst) {
    ...
    switch ($(input).attr("id")) {
        case "issue_start_date" :
            ...
            var popup_pos = $("#issue_start_date").offset();
            setTimeout(function () {
                inst.dpDiv.css({
                    top: (popup_pos.top - $('.window_wrap').offset().top) + 40,
                    left: popup_pos.left - 113
                });
            }, 0);
        ...
        case "issue_due_date" :
            ...
            var popup_pos = $("#issue_due_date").offset();
            setTimeout(function () {
                inst.dpDiv.css({
                    top: (popup_pos.top - $('.window_wrap').offset().top) + 40,
                    left: popup_pos.left - 113
